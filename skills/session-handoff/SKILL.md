...
- Performance claims carry their regime: "3× on many-small-record inputs, ~1× on few-large," never a bare "3× faster."
...
host service. (A continuation handoff: one line plus "see `handoff-2026-05.md` §1".)
```
