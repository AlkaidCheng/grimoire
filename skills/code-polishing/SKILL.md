...
Each hit: replace with an in-code explanation, or delete if the code is self-explanatory. "See PR #142" → "We bound this to 4096 because larger values trigger ENOMEM on macOS" (assuming that's actually why).
